...
SET (LIBRARY_OUTPUT_PATH ${VTKSLICER_BINARY_DIR}/bin/ CACHE PATH 
     "Single output directory for building all libraries.")

SET (EXECUTABLE_OUTPUT_PATH ${VTKSLICER_BINARY_DIR}/bin/ CACHE PATH 
...
IF (USE_VTK_FILE)
  ...
  # This value has to be set so that it can be use in vtkSlicerConfigure.h.in
  # otherwise the BUILD_SHARED_LIB from VTK's vtkConfigure.h file is picked
  # first :(

  SET(VTKSLICER_BUILD_SHARED_LIBS ${BUILD_SHARED_LIBS} CACHE INTERNAL 
      "Is this VTKSLICER built with shared libraries.")
...
IF (VTK_WRAP_TCL)
  ...
  SET(VTKSLICER_WRAP_TCL  ${WRAP_TCL} CACHE INTERNAL 
      "Wrap classes into the TCL interpreted language.")

  IF (VTKSLICER_WRAP_TCL)
    ...
    ELSE (NOT VTK_WRAP_TCL_EXE)
      ...
      FIND_FILE (VTK_WRAP_HINTS hints ${VTKSLICER_SOURCE_DIR}/Wrapping)
...
IF (VTK_WRAP_PYTHON)
  ...
  SET(VTKSLICER_WRAP_PYTHON  ${WRAP_PYTHON} CACHE INTERNAL 
      "Wrap classes into the Python interpreted language.")

  IF (VTKSLICER_WRAP_PYTHON)
...
IF (VTK_WRAP_JAVA)
  ...
  SET(VTKSLICER_WRAP_JAVA  ${WRAP_JAVA} CACHE INTERNAL 
      "Wrap classes into the Java interpreted language.")

  IF (VTKSLICER_WRAP_JAVA)
    ...
    IF (VTK_WRAP_JAVA_EXE AND VTK_PARSE_JAVA_EXE)
      ...
      IF (NOT VTK_JAVA_HOME)
        SET (VTK_JAVA_HOME ${VTKSLICER_BINARY_DIR}/java/vtk CACHE PATH "Path to Java install")
