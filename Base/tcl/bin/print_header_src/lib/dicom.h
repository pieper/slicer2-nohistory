...
int           num_data__dictionary_elements = 738;
   ...
   /*
    * define the group/element pairs we're interested in here
    */
   groups[0] = 0x8; elements[0] = 0x20; /* study  date */
   groups[1] = 0x8; elements[1] = 0x0060;       /* modality */
   groups[2] = 0x8; elements[2] = 0x0080;       /* hospital name */
   groups[3] = 0x8; elements[3] = 0x1030;       /* study desc */
   groups[4] = 0x8; elements[4] = 0x103e;       /* series desc */
   groups[5] = 0x10; elements[5] = 0x10;        /* patname */
   groups[6] = 0x10; elements[6] = 0x0020;      /* patient id */
   groups[7] = 0x10; elements[7] = 0x0040;      /* patient sex */
   groups[8] = 0x10; elements[8] = 0x1010;      /* patient age */
   groups[9] = 0x18; elements[9] = 0x0050;      /* thickness */
   groups[10] = 0x18; elements[10] = 0x0086;    /* echo number(s) */
   groups[11] = 0x18; elements[11] = 0x0088;    /* space between slices */
   groups[12] = 0x18; elements[12] = 0x5100;    /* Patient Position */
   groups[13] = 0x20; elements[13] = 0x0010;    /* exam number */
   groups[14] = 0x20; elements[14] = 0x0011;    /* series number */
   groups[15] = 0x20; elements[15] = 0x0013;    /* image number */
   groups[16] = 0x20; elements[16] = 0x0020;    /* Patient Orientation */
   groups[17] = 0x20; elements[17] = 0x1041;    /* Slice Location */
   groups[18] = 0x28; elements[18] = 0x0010;    /* xres */
   groups[19] = 0x28; elements[19] = 0x0011;    /* yres */
   groups[20] = 0x28; elements[20] = 0x0030;    /* pixsize_x  \ pixsize_y */
