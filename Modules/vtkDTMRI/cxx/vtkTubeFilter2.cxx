/*=========================================================================
  ...
  Module:    $RCSfile: vtkTubeFilter2.cxx,v $
...
vtkCxxRevisionMacro(vtkTubeFilter2, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkTubeFilter2);

// Construct object with radius 0.5, radius variation turned off, the number 
// of sides set to 3, and radius factor of 10.
vtkTubeFilter2::vtkTubeFilter2()
{
  this->Radius = 0.5;
...
int vtkTubeFilter2::GeneratePoints(vtkIdType offset, 
...
void vtkTubeFilter2::GenerateStrips(vtkIdType offset, vtkIdType npts, 
...
void vtkTubeFilter2::GenerateTextureCoords(vtkIdType offset,
                                          vtkIdType npts, vtkIdType *pts, 
                                          vtkPoints *inPts, 
...
vtkIdType vtkTubeFilter2::ComputeOffset(vtkIdType offset, vtkIdType npts)
{
  if ( this->SidesShareVertices )
    {
...
const char *vtkTubeFilter2::GetVaryRadiusAsString(void)
{
...
const char *vtkTubeFilter2::GetGenerateTCoordsAsString(void)
{
...
void vtkTubeFilter2::PrintSelf(ostream& os, vtkIndent indent)
{
