/*=========================================================================
  ...
  Module:    $RCSfile: vtkTubeFilter2.h,v $
...
=========================================================================*/
// .NAME vtkTubeFilter2 - filter that generates tubes around lines
// .SECTION Description
// vtkTubeFilter2 is a filter that generates a tube around each input line. 
...
#ifndef __vtkTubeFilter2_h
#define __vtkTubeFilter2_h
...
class VTK_DTMRI_EXPORT vtkTubeFilter2 : public vtkPolyDataToPolyDataFilter
{
public:
  vtkTypeRevisionMacro(vtkTubeFilter2,vtkPolyDataToPolyDataFilter);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct object with radius 0.5, radius variation turned off, the
  // number of sides set to 3, and radius factor of 10.
  static vtkTubeFilter2 *New();
...
private:
  vtkTubeFilter2(const vtkTubeFilter2&);  // Not implemented.
  void operator=(const vtkTubeFilter2&);  // Not implemented.
};
