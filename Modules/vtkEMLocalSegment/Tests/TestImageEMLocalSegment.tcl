...
#-------------------------------------------------------------------------------
switch $Mode {
    "8" { set XMLFile TestImageEMLocalSegmentDataHir.xml}
    default {set XMLFile TestImageEMLocalSegmentData.xml}
}
...
vtkImageReader Volume(1,vol)
  ...
  Volume(1,vol) SetFilePrefix  TestImageEMLocalSegmentMode$Mode
