# load in a surface file and a scalar file overlay
...
scalarReader SetFileName [file join [file dirname [info script]] .. Data lh.dart.curv]
...
proc WritePNG { {filename ""} } {
    ...
    if {$filename == ""} {
        set filename  [file join [file dirname [info script]] .. Baseline testCurv.tcl.png]
    }
