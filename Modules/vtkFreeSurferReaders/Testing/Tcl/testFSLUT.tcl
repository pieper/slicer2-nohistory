# load in a surface file and a scalar file overlay and associate a colour look up table with the overlay
...
scalarReader SetFileName [file join [file dirname [info script]] .. Data lh.dartLUT.curv]
...
#
catch "lutGreenRed Delete"
vtkFSLookupTable lutGreenRed
lutGreenRed SetLutTypeToGreenRed
mapper SetLookupTable lutGreenRed
...
proc WritePNG { {filename ""} } {
    ...
    if {$filename == ""} {
        set filename  [file join [file dirname [info script]] .. Baseline testFSLUT.tcl.png]
    }
