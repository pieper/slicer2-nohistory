/*=========================================================================
  ...
  Module:    $RCSfile: SimpleAppInputParser.h,v $
  Language:  C++
  Date:      $Date: 2003/12/07 22:32:41 $
...
public:
  ...
  /** Set the fixed image. */
  itkSetObjectMacro( ReSampleTrans, AffineTransformType );
...
private:
  ...
  AffineTransformPointer  m_ReSampleTrans;
};
