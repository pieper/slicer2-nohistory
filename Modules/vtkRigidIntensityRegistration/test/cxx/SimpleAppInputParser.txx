/*=========================================================================
  ...
  Module:    $RCSfile: SimpleAppInputParser.txx,v $
  Language:  C++
...
::Execute()
{
   ...
   ***********************/
   ...
   typedef itk::RawSliceVolumeReader<PixelType,ImageType> ReaderType;
   // typedef itk::RawVolumeReader<PixelType,ImageType> ReaderType;
   typename ReaderType::Pointer reader = ReaderType::New();
  
   try 
    {
    reader->SetFilePrefix( fixedImageFileName.c_str() );
    reader->SetFilePattern(".%03d");
    reader->SetStartSliceNumber(1);
   ...
   try 
    {
      ...
      resampler->SetTransform(m_ReSampleTrans);
      ...
      resampler->Update();
      m_MovingImage = resampler->GetOutput();

//    reader->SetFilePrefix( movingImageFileName.c_str() );
//    reader->SetFilePattern(".%03d");
//    reader->SetStartSliceNumber(1);
