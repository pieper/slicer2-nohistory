...
if {$standalone > 0} {
  ...
  if {[llength $argv ] != 7} {
    ...
    puts "This version does not center the initial image before applying 
    puts "the transform"
    puts "Usage: vtk TestMIReg-UnCenteredImages.tcl ImageBase"
...
#      __FinalTransform SetMatrix [__reg GetOutputMatrix]
#      __FinalTransform PreMultiply
#      __FinalTransform Translate   -119.531 -119.531 -73.75
#      __FinalTransform PostMultiply 
#      __FinalTransform Translate   119.531 119.531 73.75
#      __FinalTransform Inverse
#      __FinalTransform PostMultiply 
