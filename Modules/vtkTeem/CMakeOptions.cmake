...
SET (LIBRARY_OUTPUT_PATH ${VTKTEEM_BINARY_DIR}/bin/ CACHE PATH 
     "Single output directory for building all libraries.")

SET (EXECUTABLE_OUTPUT_PATH ${VTKTEEM_BINARY_DIR}/bin/ CACHE PATH 
...
IF (USE_VTK_FILE)
  ...
  SET(VTKTEEM_BUILD_SHARED_LIBS ${BUILD_SHARED_LIBS} CACHE INTERNAL 
      "Is this VTKTEEM built with shared libraries.")
...
IF (VTK_WRAP_TCL)
  ...
  IF (VTKTEEM_WRAP_TCL)
    ...
    ELSE (NOT VTK_WRAP_TCL_EXE)
      ...
      FIND_FILE (VTK_WRAP_HINTS hints ${VTKTEEM_SOURCE_DIR}/Wrapping)
  ...
  ENDIF (VTKTEEM_WRAP_TCL)

ELSE (VTK_WRAP_TCL)

  IF (VTKTEEM_WRAP_TCL)
    MESSAGE("Warning. VTKTEEM_WRAP_TCL is ON but the VTK version you have chosen has not support for Tcl (VTK_WRAP_TCL is OFF). Please set VTKTEEM_WRAP_TCL to OFF.")
    SET (VTKTEEM_WRAP_TCL OFF)
  ENDIF (VTKTEEM_WRAP_TCL)
...
IF (VTK_WRAP_PYTHON)
  ...
  ENDIF (VTKTEEM_WRAP_PYTHON)

ELSE (VTK_WRAP_PYTHON)

  IF (VTKTEEM_WRAP_PYTHON)
    MESSAGE("Warning. VTKTEEM_WRAP_PYTHON is ON but the VTK version you have chosen has not support for Python (VTK_WRAP_PYTHON is OFF). Please set VTKTEEM_WRAP_PYTHON to OFF.")
    SET (VTKTEEM_WRAP_PYTHON OFF)
  ENDIF (VTKTEEM_WRAP_PYTHON)
...
IF (VTK_WRAP_JAVA)
  ...
  IF (VTKTEEM_WRAP_JAVA)
    ...
    IF (VTK_WRAP_JAVA_EXE AND VTK_PARSE_JAVA_EXE)
      ...
      IF (NOT VTK_JAVA_HOME)
        SET (VTK_JAVA_HOME ${VTKTEEM_BINARY_DIR}/java/vtk CACHE PATH "Path to Java install")
  ...
  ENDIF (VTKTEEM_WRAP_JAVA)

ELSE (VTK_WRAP_JAVA)

  IF (VTKTEEM_WRAP_JAVA)
    MESSAGE("Warning. VTKTEEM_WRAP_JAVA is ON but the VTK version you have chosen has not support for Java (VTK_WRAP_JAVA is OFF). Please set VTKTEEM_WRAP_JAVA to OFF.")
    SET (VTKTEEM_WRAP_JAVA OFF)
  ENDIF (VTKTEEM_WRAP_JAVA)
