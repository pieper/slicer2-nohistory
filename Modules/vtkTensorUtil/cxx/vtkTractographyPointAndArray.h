...
//BTX
class VTK_TENSORUTIL_EXPORT vtkTractographyPoint { //;prevent man page generation
public:
...
//BTX
class VTK_TENSORUTIL_EXPORT vtkTractographyArray { //;prevent man page generation
public:
